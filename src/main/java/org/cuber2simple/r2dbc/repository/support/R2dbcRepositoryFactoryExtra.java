...
public class R2dbcRepositoryFactoryExtra extends R2dbcRepositoryFactory {
    ...
    public R2dbcRepositoryFactoryExtra(DatabaseClient databaseClient, ReactiveDataAccessStrategy dataAccessStrategy) {
    ...
    public R2dbcRepositoryFactoryExtra(R2dbcEntityOperations operations) {
        super(operations);
